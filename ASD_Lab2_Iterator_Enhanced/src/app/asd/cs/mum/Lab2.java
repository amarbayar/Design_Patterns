...
import impl.asd.cs.mum.RegularSwimmers;
import impl.asd.cs.mum.ReverseSwimmers;
import impl.asd.cs.mum.SelectiveSwimmers;
import itr.asd.cs.mum.MyList;
...
public class Lab2 extends javax.swing.JFrame
{
	...
	public Lab2()   
	{
		...
		JScrollPane1.setBounds(12,60,190,204);
	...
	{
		i = new RegularSwimmers(slist);
		Iterator itr = i.iterate();
		while(itr.hasNext()){
	...
	{
		MyList myList = new MyList(slist);
		Iterator itr = myList.reverseIterator();
		while(itr.hasNext()){
			Swimmer swimmer = (Swimmer)itr.next();
